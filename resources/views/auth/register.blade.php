...
<div class="login login-3 wizard d-flex flex-column flex-lg-row flex-column-fluid wizard" id="kt_login">
    ...
    <div class="login-aside d-flex flex-column flex-row-auto">
        ...
        <div class="d-flex flex-column-auto flex-column pt-15 px-30">
            <!--begin::Aside header-->
            <a href="https://www.podcasthawk.com" class="login-logo py-6" title="Podcast Hawk - homepage">
        ...
        <div class="aside-img-wizard d-flex flex-row-fluid bgi-no-repeat bgi-position-y-bottom bgi-position-x-center pt-2 pt-lg-5"
            style="background-position-y: calc(100% + 3rem); background-image: url(https://user.podcasthawk.com/assets/media/svg/illustrations/features.svg)">
        </div>
        <!--end::Aside Bottom-->
    </div>
    <!--begin::Aside-->
    ...
    <div class="login-content flex-column-fluid d-flex flex-column p-10">
        ...
        <div class="text-right d-flex justify-content-center">
            <div class="top-signup text-right d-flex justify-content-end pt-5 pb-lg-0 pb-10">
                ...
                <a href="https://podcasthawk.com/contact/" class="font-weight-bolder text-primary font-size-h4 ml-2" id="kt_login_signup">Contact Us</a>
            </div>
        </div>
        <!--end::Top-->
                ...
                <form class="form" novalidate="novalidate" id="kt_login_signup_form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                        ...
                        <div class="pb-10 pb-lg-15">
                            <h3 class="font-weight-bolder text-dark display5">Create Your Account</h3>
                            <div class="text-muted font-weight-bold font-size-h4">
                                Already have an account?
                                <a href="/" class="text-primary font-weight-bolder">Sign In</a>
                            </div>
                        </div>
                        <!--begin::Title-->
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6 " name="password" placeholder="You password" value="" />
                        </div>
                        <!--end::Form Group-->
                        <!--begin::Form Group-->
                        <div class="form-group">
                            <div class="checkbox-inline">
                                <label class="checkbox checkbox-outline checkbox-success">
                                    <input type="checkbox" class="form-control h-auto py-7 px-6" name="terms"/>
                                    <span style="background:white;"></span>
                                    By checking this box I confirm I've read and agreed to our&nbsp;<a href="https://podcasthawk.com/terms-conditions/" rel="nofollow">terms and conditions</a>.
                                </label>
                            </div>
                        </div>
                        <!--end::Form Group-->
                    ...
                    <div class="pb-5" data-wizard-type="step-content">
                        ...
                        <div class="pt-lg-0 pt-5 pb-15">
                            ...
                            <div class="text-muted font-weight-bold font-size-h4">
                                Some more information about your account
                            </div>
                        </div>
                        <!--begin::Title-->
                        <!--begin::Form Group-->
                       ...
                       <!--end::Form Group-->
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="business_name" placeholder="Business name (optional)" value="" />
                        </div>
                        <!--end::Form Group-->
                    ...
                    <div class="pb-5" data-wizard-type="step-content">
                        <!--begin::Title-->
                        <div class="pt-lg-0 pt-5 pb-15">
                            <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Addition Information</h3>
                            <div class="text-muted font-weight-bold font-size-h4">
                        ...
                        <!--end::Title-->
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="business_type" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6">
                                ...
                                <!--begin::Input-->
                                <div class="form-group">
                                    <label class="font-size-h6 font-weight-bolder text-dark">Interested In</label>
                                    <select name="interested_in" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6">
                                        <option value="">Select</option>
                                        <option value="promoting">Promoting my brand</option>
                                        <option value="competitors">Watching competitors</option>
                                        <option value="mentions">Monitoring my brand mentions</option>
